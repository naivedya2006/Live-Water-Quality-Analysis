...
st.set_page_config(page_title="Satellite Water Quality", page_icon="🛰️", layout="wide")

# --- 2. GEE AUTHENTICATION ---
@st.cache_resource
def authenticate_gee():
    try:
        # Scenario A: Live Server (Using Streamlit Secrets)
        ...
        # Scenario B: Local Computer (Using credentials.json)
        else:
...
# --- 3. APP HEADER ---
st.title("🛰️ Satellite Water Quality Analysis Dashboard")
st.markdown("Monitoring Optically Active Parameters via Sentinel-2 & Landsat 8 Imagery (Phase 1)")
...
# --- 5. MAIN SATELLITE LOGIC & DISPLAY ---
